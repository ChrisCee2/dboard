...
public class WorkspaceModel
{
    ...
    public WorkspaceModel(List<NodeModelBase> nodes, List<EdgeModel> edges, NotesModel notes, int x, int y, string canvasImagePath, string workspaceImagePath, string windowImagePath)
    {
        Nodes = nodes;
        Edges = edges;
        Notes = notes;
