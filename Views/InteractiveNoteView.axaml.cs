...
public partial class InteractiveNoteView : Grid
{
    ...
    protected void PointerPressed(object sender, PointerPressedEventArgs e)
    {
        ...
        if (clickProperties.IsLeftButtonPressed && e.ClickCount >= 2 && DataContext is NoteViewModel viewModel)
        {
